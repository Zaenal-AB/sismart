...
$rkpp_7a2 = select("SELECT * FROM rkpp_7a2");
$main_data = select("SELECT * FROM data_7a2");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_7a2($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-7a2.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VII-A Pekan Ke-2</h3>
                                                <a href="cetak/rkpp-7a2.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VII-A</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-7a2.php" class="btn btn-primary float-sm-right m-2">Pekan II</a>
...
<?php foreach ($rkpp_7a2 as $key => $row) : ?>
