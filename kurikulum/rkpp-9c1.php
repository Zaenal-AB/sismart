...
$rkpp_9c1 = select("SELECT * FROM rkpp_9c1");
$main_data = select("SELECT * FROM data_9c1");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_9c1($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-9c1.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas IX-C Pekan Ke-1</h3>
                                                <a href="cetak/rkpp-9c1.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF IX-C</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-9c1.php" class="btn btn-primary float-sm-right m-2">Pekan I</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php foreach ($rkpp_9c1 as $key => $row) : ?>
