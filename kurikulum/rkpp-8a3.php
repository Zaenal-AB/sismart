...
$rkpp_8a1 = select("SELECT * FROM rkpp_8a1");
$main_data = select("SELECT * FROM data_8a1");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_8a1($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-8a1.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-A Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-8a1.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-A</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8a4.php" class="btn btn-secondary float-sm-right m-2">Pekan IV</a>
                                                <a href="rkpp-8a3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
                                                <a href="rkpp-8a2.php" class="btn btn-secondary float-sm-right m-2">Pekan II</a>
                                                <a href="rkpp-8a1.php" class="btn btn-secondary float-sm-right m-2">Pekan I</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php foreach ($rkpp_8a1 as $key => $row) : ?>
