...
$rkpp_9b4 = select("SELECT * FROM rkpp_9b4");
$main_data = select("SELECT * FROM data_9b4");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_9b4($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-9b4.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas IX-B Pekan Ke-4</h3>
                                                <a href="cetak/rkpp-9b4.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF IX-B</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-9b4.php" class="btn btn-primary float-sm-right m-2">Pekan IV</a>
                                                <a href="rkpp-9b3.php" class="btn btn-secondary float-sm-right m-2">Pekan III</a>
...
<?php foreach ($rkpp_9b4 as $key => $row) : ?>
