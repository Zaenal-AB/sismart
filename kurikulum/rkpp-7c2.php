...
$rkpp_7c2 = select("SELECT * FROM rkpp_7c2");
$main_data = select("SELECT * FROM data_7c2");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_7c2($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-7c2.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VII-C Pekan Ke-2</h3>
                                                <a href="cetak/rkpp-7c2.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VII-C</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-7c3.php" class="btn btn-secondary float-sm-right m-2">Pekan III</a>
                                                <a href="rkpp-7c2.php" class="btn btn-primary float-sm-right m-2">Pekan II</a>
...
<?php foreach ($rkpp_7c2 as $key => $row) : ?>
