...
$data = select("SELECT * FROM data_8d3");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VIII-D</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VIII-D</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VIII-D.pdf', \Mpdf\Output\Destination::INLINE);
