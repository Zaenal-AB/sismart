...
$data = select("SELECT * FROM data_9a1");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas IX-A</h3>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP IX-A.pdf', \Mpdf\Output\Destination::INLINE);
