...
$data = select("SELECT * FROM data_8c3");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VIII-C</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VIII-C</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VIII-C.pdf', \Mpdf\Output\Destination::INLINE);
