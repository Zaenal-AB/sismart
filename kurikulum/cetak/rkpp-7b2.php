...
$data = select("SELECT * FROM data_7b2");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VII-B</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VII-B</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VII-B.pdf', \Mpdf\Output\Destination::INLINE);
