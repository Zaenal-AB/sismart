...
$data = select("SELECT * FROM data_7d4");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VII-D</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VII-D</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VII-D.pdf', \Mpdf\Output\Destination::INLINE);
