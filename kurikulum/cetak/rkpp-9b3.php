...
$data = select("SELECT * FROM data_9b3");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas IX-B</h3>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP IX-B.pdf', \Mpdf\Output\Destination::INLINE);
