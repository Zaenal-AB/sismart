...
$data = select("SELECT * FROM data_9d2");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas IX-D</h3>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP IX-D.pdf', \Mpdf\Output\Destination::INLINE);
