...
$data = select("SELECT * FROM data_9c1");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas IX-C</h3>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP IX-C.pdf', \Mpdf\Output\Destination::INLINE);
