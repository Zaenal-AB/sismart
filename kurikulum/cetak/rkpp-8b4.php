...
$data = select("SELECT * FROM data_8b4");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VIII-B</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VIII-B</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VIII-B.pdf', \Mpdf\Output\Destination::INLINE);
