...
$data = select("SELECT * FROM data_7c1");
...
<body>
    ...
    <h3 class="judul">Rencana Kegiatan Pembelajaran Pekanan (RKPP) Kelas VII-C</h3>
...
foreach ($data as $row) {
    ...
    $html .= '
                ...
                <td class="col2">
                    ...
                    <p class="tex">Wali Kelas VII-C</p>
                    <div>
...
$mpdf->WriteHTML($html);
$mpdf->Output('RKPP VII-C.pdf', \Mpdf\Output\Destination::INLINE);
