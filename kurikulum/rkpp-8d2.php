                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-D Pekan Ke-2</h3>
                                                <a href="cetak/rkpp-9d2.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-D</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8d2.php" class="btn btn-primary float-sm-right m-2">Pekan II</a>
