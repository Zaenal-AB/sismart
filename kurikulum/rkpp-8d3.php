...
$rkpp_8d3 = select("SELECT * FROM rkpp_8d3");
$main_data = select("SELECT * FROM data_8d3");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_8d3($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-8d3.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-D Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-8d3.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-D</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8d4.php" class="btn btn-secondary float-sm-right m-2">Pekan IV</a>
                                                <a href="rkpp-8d3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
...
<?php foreach ($rkpp_8d3 as $key => $row) : ?>
