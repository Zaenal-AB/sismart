...
$rkpp_9d3 = select("SELECT * FROM rkpp_9d3");
$main_data = select("SELECT * FROM data_9d3");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_9d3($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-9d3.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas IX-D Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-9d3.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF IX-D</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-9d3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
...
<?php foreach ($rkpp_9d3 as $key => $row) : ?>
