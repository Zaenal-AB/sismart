...
$rkpp_7c3 = select("SELECT * FROM rkpp_7c3");
$main_data = select("SELECT * FROM data_7c3");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_7c3($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-7c3.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VII-C Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-7c3.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VII-C</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-7c4.php" class="btn btn-secondary float-sm-right m-2">Pekan IV</a>
                                                <a href="rkpp-7c3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
                                                <a href="rkpp-7c2.php" class="btn btn-secondary float-sm-right m-2">Pekan II</a>
                                                <a href="rkpp-7c1.php" class="btn btn-secondary float-sm-right m-2">Pekan I</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php foreach ($rkpp_7c3 as $key => $row) : ?>
