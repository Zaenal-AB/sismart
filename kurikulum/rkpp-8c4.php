...
$rkpp_8c4 = select("SELECT * FROM rkpp_8c4");
$main_data = select("SELECT * FROM data_8c4");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_8c4($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-8c4.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-C Pekan Ke-4</h3>
                                                <a href="cetak/rkpp-8c4.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-C</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8c4.php" class="btn btn-primary float-sm-right m-2">Pekan IV</a>
...
<?php foreach ($rkpp_8c4 as $key => $row) : ?>
