...
$rkpp_7a3 = select("SELECT * FROM rkpp_7a3");
$main_data = select("SELECT * FROM data_7a3");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_7a3($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-7a3.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VII-A Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-7a3.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VII-A</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-7a3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
...
<?php foreach ($rkpp_7a3 as $key => $row) : ?>
