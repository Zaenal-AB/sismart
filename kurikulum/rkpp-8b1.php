...
$rkpp_8b1 = select("SELECT * FROM rkpp_8b1");
$main_data = select("SELECT * FROM data_8b1");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_8b1($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-8b1.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-B Pekan Ke-1</h3>
                                                <a href="cetak/rkpp-8b1.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-B</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8b1.php" class="btn btn-primary float-sm-right m-2">Pekan I</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php foreach ($rkpp_8b1 as $key => $row) : ?>
