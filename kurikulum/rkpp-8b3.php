...
$rkpp_8b3 = select("SELECT * FROM rkpp_8b3");
$main_data = select("SELECT * FROM data_8b3");


//UBAH DATA KELAS
if (isset($_POST['UbahMain'])) {
    if (ubah_data_8b3($_POST) > 0) {
        echo "<script> 
        document.location.href = 'rkpp-8b3.php';
        </script>";
    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">RKPP Kelas VIII-B Pekan Ke-3</h3>
                                                <a href="cetak/rkpp-8b3.php" target="_blank" class="btn btn-danger float-sm-right">Cetak PDF VIII-B</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="rkpp-8b3.php" class="btn btn-primary float-sm-right m-2">Pekan III</a>
...
<?php foreach ($rkpp_8b3 as $key => $row) : ?>
