...
if (isset($_POST['tambah'])) {
    if (create_tasmi($_POST) > 0) {
        echo "<script> alert('Catatan Tasmi Berhasil Ditambahkan')
        document.location.href = 'data-tasmi.php';
        </script>";
    } else {
        echo "<script> alert('Catatan Tasmi Gagal Ditambahkan')
        document.location.href = 'data-tasmi.php';
        </script>";
    }
}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <label for="nama">Nama Siswa</label>
                        <select data-live-search="true" type="text" class="form-control  mb-1" id="nama" name="nama" value="<?= $tasmi['nama']; ?>" required>
